...
On the other hand, there are examples where our network is obviouly wrong and outputs predictions that are not plausible.
...
\caption{Sample bad predictions of the ColorUNet}
\label{worse}
\end{center}
\end{figure*}
...
\caption{Confidence map for bad predictions of the ColorUNet}
\label{confidence}
\end{center}
\end{figure*}
