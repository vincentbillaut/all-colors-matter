...
Figure \ref{•} gives some examples of correct colorizations made by the ColoringUNet. We see that in some cases, the colorization is more appealing than the original image.
