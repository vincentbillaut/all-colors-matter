...
Authors of \cite{ronneberger2015unet} have shown that conenctions between hidden layers of a bottleneck neural network could enhance the performance gratly, by helping the upsampling process and improving the gradient flow. 
